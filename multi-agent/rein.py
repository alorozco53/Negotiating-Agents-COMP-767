...
def main():
    ...
    parser.add_argument('--alice_model_file',default='rnn_model.th', type=str,
        help='Alice model file')
    parser.add_argument('--bob_model_file',default="rnn_model.th" ,type=str,
        help='Bob model file')
    parser.add_argument('--joe_model_file',default="rnn_model.th" ,type=str,
        help='Joe model file')
    parser.add_argument('--output_model_file',default="rnn_modelnew.th", type=str,
        help='output model file')
    parser.add_argument('--context_file', default="data/negotiate/selfplay.txt",type=str,
        help='context file')
    ...
    parser.add_argument('--selection_model_file', type=str,  default='selection_model.th',
    ...
    joe_ty = get_agent_type(joe_model)
    joe = joe_ty(joe_model, args, name='Joe', train=False)

    

    dialog = Dialog([alice, bob,joe], args)
