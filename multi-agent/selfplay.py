...
def main():
    ...
    joe_model = utils.load_model(args.joe_model_file)
    joe_ty = get_agent_type(joe_model, args.smart_bob)
    joe = joe_ty(bob_model, args, name='JOe', train=False, diverse=args.diverse_bob)
